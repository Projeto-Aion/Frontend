...
getAllPostagens(): Observable<Postagem[]> {
  return this.http.get<Postagem[]>('https://projeto-aion.herokuapp.com/postagens', this.token)
}
...
putPostagem(postagem: Postagem): Observable<Postagem> {
  return this.http.put<Postagem>('https://projeto-aion.herokuapp.com/postagens', postagem, this.token)
}
